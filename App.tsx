...
import { FormSchema, FormData, Field } from './types';
...
const App: React.FC = () => {
  ...
  return (<>
    ...
    <div className={`flex flex-col lg:flex-row screen m-2 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
      ...
      <button
        className="fixed top-4 right-4 p-3 transition-all shadow-lg bg-blue-500 hover:bg-blue-600 text-white rounded-full"
